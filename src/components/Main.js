            ...
            <header class="border-bottom lh-1 py-3">
              <div class="row flex-nowrap justify-content-center align-items-center">
                ...
                <div class="col-4 text-center">
                  <a class="blog-header-logo text-body-emphasis text-decoration-none" href="#">Welcome!</a>
                </div>
              ...
              <div class="nav-scroller py-1 mb-3 border-bottom">
                <nav class="nav nav-underline justify-content-between">
                  <a class="nav-item nav-link link-body-emphasis active" href="#aboutme">About</a>
      ...
      <br></br>
            ...
            <div class="row mb-2">
              ...
              <div class="col-md-12">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                  <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-success-emphasis">Retro Pokemon App</strong>
                    <h3 class="mb-0"><b>PokeRumble</b></h3>
                    <div class="mb-1 text-body-secondary" style={{display: "flex", justifyContent: "start", alignItems: "center", listStyleType: "none"}}>
                        <li style={{marginRight: 12}}>HTML</li>
                        <li style={{marginRight: 12}}>CSS</li>
                        <li style={{marginRight: 12}}>Javascript</li>
                        <li style={{marginRight: 12}}>jQuery</li>
                    </div>
          ...
          <h2 class="display-5 link-body-emphasis mb-1" id="skills">Technical Skills</h2>
          <hr></hr>
          ...
          <p>This is some additional paragraph placeholder content. It's a slightly shorter version of the other highly repetitive body text used throughout.</p>
                ...
                <article class="blog-post"> 
          <h2 class="display-5 link-body-emphasis mb-1">Education</h2>
          <hr></hr>
          ...
          <p>This is some additional paragraph placeholder content. It's a slightly shorter version of the other highly repetitive body text used throughout.</p> */}
                ...
                <article class="blog-post">
          <h2 class="display-5 link-body-emphasis mb-1">Slice of Life</h2>
          <hr></hr>
          ...
          <a class="btn btn-outline-secondary rounded-pill disabled" aria-disabled="true">Newer</a>
              ...
              <div class="col-md-4">
                <div class="position-sticky" style={{top: 2}}>
                  ...
                  <div>
                    <h1 class="fst-italic" id="contact">Lets Connect!</h1>
                    <ul class="list-unstyled">
                      <li>
                        ...
                        <li style={{height: 60}} aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><a href="https://www.linkedin.com/in/timothy-rodriguez-swe/" target="_blank"><FontAwesomeIcon icon={faLinkedin} style={{height: 60, color: "black"}}/></a></li>
                      ...
                      <li>
                        ...
                        <li style={{height: 60}} aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><a href="https://github.com/timorodr" target="_blank"><FontAwesomeIcon icon={faGithub} style={{height: 60, color: "black"}}/></a></li>
                      ...
                      <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top" href="mailto: timothyjayrodriguez@gmail.com" target="_blank">
                        <li style={{height: 60}} aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><a href="mailto: timothyjayrodriguez@gmail.com" target="_blank"><FontAwesomeIcon icon={faEnvelope} style={{height: 60, color: "black"}}/></a></li>
                          {/* <svg class="bd-placeholder-img" width="100%" height="96" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg> */}
                          <div class="col-lg-8">
