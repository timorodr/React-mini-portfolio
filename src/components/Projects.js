...
const Projects = (props) => {
    ...
    <div className="projects">
        ...
        <div className="projects-container2">
            ...
            <div className="project-text">
                <h2 className="project-title">Study Buddy</h2>
                <p className="project-description">Study Buddy is a web application that allows users to create decks of flashcards to help them study anything from software development to foreign languages to trivia. This project was completed in collaboration with 3 other team members.
                </p>
                <ul className="project-languages">
                    <li className="project-li">MongoDB</li>
                    <li className="project-li">Express.js</li>
